package cn.cyg.enterprise.controller.common;

import cn.cyg.enterprise.util.UriUtils;
    ...
    public Result uploadV2(HttpServletRequest httpServletRequest) throws URISyntaxException {
        ...
        for (int i = 0; i < multipartFiles.size(); i++) {
            ...
            try {
                ...
                fileNames.add(UriUtils.getHost(new URI(httpServletRequest.getRequestURL() + "")) + "/upload/" + newFileName);
            } catch (IOException e) {
                e.printStackTrace();
                return ResultGenerator.genFailResult("文件上传失败");
            }
