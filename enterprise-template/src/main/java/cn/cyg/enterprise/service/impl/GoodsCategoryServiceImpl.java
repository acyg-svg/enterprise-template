...
import cn.cyg.enterprise.controller.vo.IndexCategoryVO;
...
import cn.cyg.enterprise.controller.vo.SearchPageCategoryVO;
import cn.cyg.enterprise.controller.vo.SecondLevelCategoryVO;
import cn.cyg.enterprise.controller.vo.ThirdLevelCategoryVO;
    ...
    public List<IndexCategoryVO> getCategoriesForIndex() {
        ...
        List<GoodsCategory> firstLevelCategories =
                goodsCategoryMapper.selectByLevelAndParentIdsAndNumber
                        (Collections.singletonList(0L), CategoryLevelEnum.LEVEL_ONE.getLevel(), Constants.INDEX_CATEGORY_NUMBER);
