package cn.cyg.enterprise.common;
...
public class Constants {
    ...
    public final static int PORTAL_ABOUT_NUMBER = 1;//企业简介内容数量

    public final static int INDEX_CAROUSEL_NUMBER = 6;//首页轮播图数量(可根据自身需求修改)
    ...
    public final static int INDEX_ANNOUNCEMENT_NUMBER = 8;//首页公告条数
